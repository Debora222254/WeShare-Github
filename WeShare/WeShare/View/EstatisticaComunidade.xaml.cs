...
{
    /// <summary>
    /// Interaction logic for EstatisticaComunidade.xaml
    /// </summary>
    public partial class EstatisticaComunidade : Page
    {
        public EstatisticaComunidade()
        {
            InitializeComponent();
            ...
            SeriesCollection = new SeriesCollection
            {
                ...
                {
                    Title = "Crianças",
                    Values = new ChartValues<double> {52,101 , 202, 402},
